...
<link rel="stylesheet" href="{{ asset('frontend/items/libs/font-material/css/material-design-iconic-font.min.css') }}">
				...
				<div class="block-content">
					<div class="container">
						...
						<div class="tab-nav">
							<ul>
								<li class="active">
									<a data-toggle="tab" href="#all-publicad">
										<img src="img/product/product-category-0.png" alt="All Product">
										<span>All Products</span>
									</a>
								</li>
     @foreach ( $cdepartment as $items)
                                <li>
						...
						<div class="tab-content">
							<!-- All Products -->
							<div role="tabpanel" class="tab-pane fade in active" id="all-publicad">
								<div class="products owl-theme owl-carousel">
                                    @foreach ( $allpublicad as $items)
